...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "IoTrack Learning Kit — IoT-Powered Robotic Arm Learning Platform" },
      { name: "description", content: "An immersive learning experience that teaches IoT fundamentals through an interactive robotic arm demonstration." },
      { property: "og:title", content: "IoTrack Learning Kit" },
      { property: "og:description", content: "Learn IoT fundamentals through an interactive robotic arm demonstration." },
